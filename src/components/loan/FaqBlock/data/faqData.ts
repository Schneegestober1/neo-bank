...
export const usageFaq: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'The settlement date is the date from which you can pay off the debt for the reporting period. It falls on the first calendar day after the last day of the reporting period. The first date is reported by the bank upon card issuance and then in the monthly account statement.',
  },
  {
    question: 'What do I need to know about interest rates?',
    answer:
      'Each month a statement is generated containing the amount and timing of the minimum payment, as well as the total amount of debt.',
  },
]